...
namespace UnityEditor.ShaderGraph
{
    ...
    public static class ShaderSpliceUtil
    {
        ...
        public class TemplatePreprocessor
        {
            ...
            public TemplatePreprocessor(HashSet<string> activeFields, Dictionary<string, string> namedFragments, bool debugOutput, string templatePath, string sharedTemplatePath, List<string> sourceAssetDependencyPaths, string buildTypeAssemblyNameFormat, ShaderStringBuilder outShaderCodeResult = null)
            {
                this.activeFields = activeFields;
                this.namedFragments = namedFragments;
                this.debugOutput = debugOutput;
                this.templatePath = templatePath;
                this.sharedTemplatePath = sharedTemplatePath;
            ...
            private void ProcessIncludeCommand(Token includeCommand, int lineEnd)
            {
                if (Expect(includeCommand.s, includeCommand.end, '('))
                {
                    ...
                    {
                        var includeLocation = Path.Combine(sharedTemplatePath, param.GetString());
