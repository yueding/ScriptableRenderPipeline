...
namespace UnityEngine.Experimental.Rendering.HDPipeline
{
    public partial class LTCAreaLight
    {
        ...
        public void Build()
        {
            ...
            if (m_refCounting == 0)
            {
                m_LtcData = new Texture2DArray(k_LtcLUTResolution, k_LtcLUTResolution, 5, TextureFormat.RGBAHalf, false /*mipmap*/, true /* linear */)
                {
                ...
                LoadLUT(m_LtcData, 3, TextureFormat.RGBAHalf, s_LtcMatrixData_CookTorrance);
                LoadLUT(m_LtcData, 4, TextureFormat.RGBAHalf, s_LtcMatrixData_Charlie);
