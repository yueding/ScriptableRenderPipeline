...
namespace UnityEditor.ShaderGraph
{
    ...
    public class HDLitMasterNode : MasterNode<IHDLitSubShader>, IMayRequirePosition, IMayRequireNormal, IMayRequireTangent
    {
        ...
        {
            //bool emissionGI = IsSlotConnected(HDLitMasterNode.EmissionSlotId);
            //if (!emissionGI)
            //{
            //    var colorSlot = FindSlot<MaterialSlot>(HDLitMasterNode.EmissionSlotId) as ColorRGBMaterialSlot;
